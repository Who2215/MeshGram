(function () {
  const en = {
    ...
    hero_eyebrow: 'Next-generation mesh connection', hero_title: 'Messages find', hero_title_em: 'their way.', hero_slogan: 'Connection does not have to be nearby.', hero_lead: 'MeshGram connects people through nearby devices over BLE and uses an encrypted internet fallback for long-distance routes.', hero_download: 'Download MeshGram', hero_explore: 'Understand it in a minute', trust_android: 'Android 6+', trust_encryption: 'E2E encryption', latest_release: 'Latest release',
